...
namespace ASPMustakacite.Controllers
{
    public class PostTypesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Description,Status")] PostType postType)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Description,Status")] PostType postType)
        {
            if (id != postType.Id)
            {
                return NotFound();
